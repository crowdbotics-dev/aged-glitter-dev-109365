"""
Django settings for aged_glitter_dev_109365 project.
...
ROOT_URLCONF = 'aged_glitter_dev_109365.urls'
...
WSGI_APPLICATION = 'aged_glitter_dev_109365.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_glitter_dev_109365 API",
    "DESCRIPTION": "API documentation for aged_glitter_dev_109365 App",
    "VERSION": "v1",
}
